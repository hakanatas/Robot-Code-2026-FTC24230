...
@Autonomous(name = "7-blue_Yakın_9")
public class blueYakinAuto9 extends OpMode {
    ...
    public void autonomousPathUpdate() {
        ...
        switch (pathState) {
            ...
            case 8:
                ...
                if (!follower.isBusy()) {
                    // PGPBehind'a ulaştık, şimdi YAVAŞ başla ve intake aç
                     // ← YAVAŞ başlat
            ...
            case 9:
                // PGP'ye giderken - YAVAŞ, intake AÇIK (TOPLAR BURADA!)
                Superstructure.setIntakeSystem(1);
                 // ← YAVAŞ kal!
