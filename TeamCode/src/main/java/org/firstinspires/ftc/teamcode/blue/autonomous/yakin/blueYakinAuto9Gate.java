...
@Autonomous(name = "3-blue_Yakın_Kapı_9")
public class blueYakinAuto9Gate extends OpMode {
    ...
    private final Pose backPose = new Pose(30.000, 84.000, Math.toRadians(180));
        ...
        switch (pathState) {
            ...
            case 2:
                ...
                if (revolverEmpty) {
                    ...
                    // PPGBehind'a HIZLI git (toplar daha önde)
