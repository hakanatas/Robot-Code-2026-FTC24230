...
@Autonomous(name = "5-blue_Uzak_Human_9+3")
public class blueUzakAutoHuman9_3 extends OpMode {
    ...
    private final Pose score3Pose = new Pose(60.000, 27.500, Math.toRadians(180));
    private final Pose human2Pose = new Pose(13.000, 11.000, Math.toRadians(180));
    private final Pose score4Pose = new Pose(61.000, 26.000, Math.toRadians(180));
    private final Pose parkPose = new Pose(55.000, 26.000, Math.toRadians(180));
