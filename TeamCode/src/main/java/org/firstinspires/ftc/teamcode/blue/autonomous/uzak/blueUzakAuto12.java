...
@Autonomous(name = "2-blue_Uzak_12")
public class blueUzakAuto12 extends OpMode {
    ...
    private final Pose score2Pose = new Pose(60.000, 25.000, Math.toRadians(180));
    ...
    private final Pose score3Pose = new Pose(60.000, 25.000, Math.toRadians(180));
    private final Pose PGPPoseBehind = new Pose(42.000, 58.000, Math.toRadians(180));
    private final Pose PGPPose = new Pose(12.000, 58.000, Math.toRadians(180));
    private final Pose score4Pose = new Pose(61.000, 70.000, Math.toRadians(180));
    private final Pose parkPose = new Pose(61.000, 64.000, Math.toRadians(180));

    // PATHLER (DÜZELTİLMİŞ)
    private Path score1;
    private PathChain human, score2, GPPBehind, GPP, score3, PGPBehind, PGP, score4, park;
    ...
    public void buildPaths() {
        ...
        PGPBehind = follower.pathBuilder()
                .addPath(new BezierLine(score3Pose, PGPPoseBehind))
                .setLinearHeadingInterpolation(score3Pose.getHeading(), PGPPoseBehind.getHeading())
                .build();
        ...
        score4 = follower.pathBuilder()
                .addPath(new BezierLine(PGPPose, score4Pose))
                .setLinearHeadingInterpolation(PGPPose.getHeading(), score4Pose.getHeading())
                .build();
    ...
    public void autonomousPathUpdate() {
        ...
        // 29.7 saniye timeout kontrolü - PARK'A GİT!
        if (opmodeTimer.getElapsedTimeSeconds() >= 29.2 && pathState != 19 && pathState != -1) {
    ...
    public void start() {
        ...
        setPathState(0);
        telemetryM.debug("Autonomous started! 4-Shoot Uzak sequence (12-BALL + HUMAN WAIT)");
    }
