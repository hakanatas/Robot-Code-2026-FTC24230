...
@Autonomous(name = "999-red_Yakın_12")
public class redYakinAuto12 extends OpMode {
    ...
    private final Pose score2Pose = new Pose(96.000, 84.300, Math.toRadians(0));
    ...
    private final Pose score3Pose = new Pose(82.500, 71.500, Math.toRadians(0));
    private final Pose GPPPoseBehind = new Pose(102.000, 38.000, Math.toRadians(0));
    private final Pose GPPPose = new Pose(131.000, 38.000, Math.toRadians(0));
    private final Pose score4Pose = new Pose(82.500, 71.500, Math.toRadians(0));
    private final Pose parkPose = new Pose(82.500, 64.000, Math.toRadians(0));
