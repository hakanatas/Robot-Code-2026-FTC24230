...
@Autonomous(name = "999-blue_Yakın_12")
public class blueYakinAuto12 extends OpMode {
    ...
    private final Pose score1Pose = new Pose(48.000, 84.300, Math.toRadians(180));
    private final Pose PPGPose = new Pose(19.000, 84.300, Math.toRadians(180));
    private final Pose score2Pose = new Pose(48.000, 84.300, Math.toRadians(180));
    ...
    private final Pose score3Pose = new Pose(61.500, 71.500, Math.toRadians(180));
    private final Pose GPPPoseBehind = new Pose(42.000, 38.000, Math.toRadians(180));
    private final Pose GPPPose = new Pose(13.000, 38.000, Math.toRadians(180));
    private final Pose score4Pose = new Pose(61.500, 71.500, Math.toRadians(180));
    private final Pose parkPose = new Pose(61.500, 64.000, Math.toRadians(180));

    // PATHLER
    private Path score1;
    private PathChain PPG, score2, PGPBehind, PGP, score3, GPPBehind, GPP, score4, park;
    ...
    public void autonomousPathUpdate() {
        ...
        if (pathState != 2 && pathState != 6 && pathState != 11 && pathState != 16 && pathState != 17 && pathState != 18 && pathState != -1) {
    ...
    public void init() {
        ...
        // Debouncer oluştur - 0.2 saniye, Rising edge
    ...
    public void start() {
        ...
        setPathState(0);
        telemetryM.debug("Autonomous started! 4-Shoot sequence (12-BALL)");
    }
