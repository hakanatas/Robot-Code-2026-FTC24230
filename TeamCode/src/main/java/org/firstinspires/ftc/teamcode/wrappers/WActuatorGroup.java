...
import org.firstinspires.ftc.teamcode.lib.AsymmetricMotionProfile;
import org.firstinspires.ftc.teamcode.lib.MathUtils;
import org.firstinspires.ftc.teamcode.lib.ProfileConstraints;
import org.firstinspires.ftc.teamcode.lib.ProfileState;
...
public class WActuatorGroup {
    ...
    public void periodic() {
        ...
        if (controller != null) {
            ...
            switch (mode) {
                case CONSTANT:
                    double direction=Math.signum(controller.getPositionError());
                    this.power += currentFeedforward*direction;
                    break;
                case ANGLE_BASED:
    ...
    public void setMaxPower(double mx){
        this.max=mx;
    }
