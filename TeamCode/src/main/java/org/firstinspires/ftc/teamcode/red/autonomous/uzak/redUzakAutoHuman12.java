...
@Disabled
@Autonomous(name = "99-red_Uzak_Human_12")
public class redUzakAutoHuman12 extends OpMode {
    ...
    private final Pose human2Pose = new Pose(131.000, 8.800, Math.toRadians(0));
    private final Pose score3Pose = new Pose(84.000, 26.000 - SCORE_POSE_Y_OFFSET_INCHES, Math.toRadians(0));
    private final Pose human3Pose = new Pose(131.000, 16.500, Math.toRadians(0));
    private final Pose score4Pose = new Pose(84.000, 26.000 - SCORE_POSE_Y_OFFSET_INCHES, Math.toRadians(0));
    private final Pose parkPose = new Pose(84.000, 35.000, Math.toRadians(0));
    ...
    public void autonomousPathUpdate() {
        ...
        if (opmodeTimer.getElapsedTimeSeconds() >= 29.2 && pathState != 18 && pathState != -1) {
