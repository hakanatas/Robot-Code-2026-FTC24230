...
@Autonomous(name = "8-blue_Yakın_Kapı_6")
public class blueYakinAuto6Gate extends OpMode {
    ...
    private final Pose backPose = new Pose(30.000, 84.300, Math.toRadians(180));
    private final Pose gatePose = new Pose(18.000, 75.000, Math.toRadians(180));
    private final Pose score2Pose = new Pose(53.000, 112.000, Math.toRadians(180));

    // PATHLER
    private Path score1;
    private PathChain PPGBehind, PPG, back, gate, score2;
    ...
    public void autonomousPathUpdate() {
        ...
        if (pathState != 2 && pathState != 9 && pathState != 10 && pathState != -1) {
    ...
    public void start() {
        ...
        setPathState(0);
        telemetryM.debug("Autonomous started! Gate sequence");
    }
