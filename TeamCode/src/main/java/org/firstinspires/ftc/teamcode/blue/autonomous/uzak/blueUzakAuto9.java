...
@Autonomous(name = "4-blue_Uzak_9")
public class blueUzakAuto9 extends OpMode {
    ...
    private final Pose score3Pose = new Pose(60.000, 27.000, Math.toRadians(180));
    private final Pose parkPose = new Pose(57.000, 40.000, Math.toRadians(180));

    // PATHLER
    private Path score1;
    private PathChain GPPBehind, GPP, score2, PGPBehind, PGP, score3, park;
    ...
    public void autonomousPathUpdate() {
        ...
        // 28 saniye timeout kontrolü
        if (opmodeTimer.getElapsedTimeSeconds() >= 29.7 && pathState != -1) {
            // Acil park modu
        ...
        switch (pathState) {
            ...
            case 3:
                // GPPBehind'a gidiliyor - HIZLI, intake AÇIK
                Superstructure.setIntakeSystem(1);


                if (!follower.isBusy()) {
                    // GPPBehind'a ulaştık, YAVAŞLA
            ...
            case 4:
                // GPP'ye giderken - YAVAŞ, intake AÇIK
                Superstructure.setIntakeSystem(1);


                if (!follower.isBusy() || revolverFull) {
                    // GPP bitti, score2'ye HIZLI git
            ...
            case 8:
                // PGPBehind'a gidiliyor - HIZLI, intake AÇIK
                Superstructure.setIntakeSystem(1);


                if (!follower.isBusy()) {
                    // PGPBehind'a ulaştık, YAVAŞLA
            ...
            case 9:
                // PGP'ye giderken - YAVAŞ, intake AÇIK
                Superstructure.setIntakeSystem(1);


                if (!follower.isBusy() || revolverFull) {
                    // PGP bitti, score3'e HIZLI git
            ...
            case 10:
                // Score3'e giderken - HIZLI, intake AÇIK
                Superstructure.setIntakeSystem(1);
    ...
    public void start() {
        ...
        setPathState(0);
        telemetryM.debug("Autonomous started! 3-Shoot Uzak sequence");
    }
