...
@Autonomous(name = "1-blue_Yakın_Kapı_12")
public class blueYakinAuto12Gate extends OpMode {
    ...
    private final Pose backPose = new Pose(27.000, 84.300, Math.toRadians(180));
    private final Pose gatePose = new Pose(18.00, 75.000, Math.toRadians(180));
    private final Pose score2Pose = new Pose(47.000, 84.300, Math.toRadians(180));
    ...
    private final Pose score4Pose = new Pose(61.000, 71.000, Math.toRadians(180));
    private final Pose parkPose = new Pose(61.000, 65.000, Math.toRadians(180));
