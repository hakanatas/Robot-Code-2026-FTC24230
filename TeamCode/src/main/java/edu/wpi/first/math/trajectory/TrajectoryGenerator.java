...
public final class TrajectoryGenerator {
  ...
  static Trajectory.State[] strArray = {new Trajectory.State()};
  static final List<Trajectory.State> arrayList = new ArrayList<>(Arrays.asList(strArray));
  private static final Trajectory kDoNothingTrajectory =
      new Trajectory(arrayList);
