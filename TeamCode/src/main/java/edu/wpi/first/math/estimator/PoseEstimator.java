...
public class PoseEstimator {
    ...
    private final GoBildaPinpointDriver m_odometry;
    ...
    public PoseEstimator(
        ...
        m_poseEstimate = m_odometry.getPose2d();
    ...
    public void resetPosition(Pose2d poseMeters) {
        ...
        m_odometry.resetPose(poseMeters);
    ...
    public void addVisionMeasurement(Pose2d visionRobotPoseMeters, double timestampSeconds) {
        ...
        m_poseEstimate = visionUpdate.compensate(m_odometry.getPose2d());
    }
    ...
    public Pose2d update() {
        return updateWithTime((double) System.nanoTime() / 1E9);
    }
    ...
    public Pose2d updateWithTime(double currentTimeSeconds) {
        Pose2d odometryEstimate = m_odometry.update();
    ...
    private static final class VisionUpdate {
        ...
        public Pose2d compensate(Pose2d pose) {
            edu.wpi.first.math.geometry.Transform2d delta = pose.minus(this.odometryPose);
