...
//  }
  ...
  @Override
  public boolean equals(Object o) { // bugs for double comparing. JD
    return o == this
        || o.getClass().isInstance(this)
            && Double.compare(vxMetersPerSecond, ((ChassisSpeeds)o).vxMetersPerSecond) == 0
            && Double.compare(vyMetersPerSecond, ((ChassisSpeeds)o).vyMetersPerSecond) == 0
            && Double.compare(omegaRadiansPerSecond, ((ChassisSpeeds)o).omegaRadiansPerSecond) == 0;
  }
